...
namespace Stl.Tests.CommandR
{
    public class CommandDispatcherTest : TestBase
    {
        ...
        public async Task LogCommandTest()
        {
            ...
            await services.CommandDispatcher().DispatchAsync(command);
        }
        ...
        public async Task DivCommandTest()
        {
            ...
            var result = await services.CommandDispatcher().DispatchAsync(command);
            result.Should().Be(2);
        }

        [Fact]
        public async Task DivByZeroTest()
        {
            var services = CreateServices();
