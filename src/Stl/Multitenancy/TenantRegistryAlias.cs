...
public class TenantRegistryAlias<TContext> : ITenantRegistry<TContext>
{
    ...
    public bool IsSingleTenant => _source.IsSingleTenant;
    public MutableDictionary<Symbol, Tenant> AllTenants => _source.AllTenants;
    public MutableDictionary<Symbol, Tenant> AccessedTenants => _source.AccessedTenants;
