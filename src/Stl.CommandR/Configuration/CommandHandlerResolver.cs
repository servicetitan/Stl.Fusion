...
{
    ImmutableArray<CommandHandler> GetCommandHandlers(Type commandType);
}
...
public class CommandHandlerResolver : ICommandHandlerResolver
{
    ...
    protected ConcurrentDictionary<Type, ImmutableArray<CommandHandler>> Cache { get; } = new();
    ...
    public ImmutableArray<CommandHandler> GetCommandHandlers(Type commandType)
