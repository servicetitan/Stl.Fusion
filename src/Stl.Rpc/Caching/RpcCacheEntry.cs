...
public sealed partial class RpcCacheEntry(RpcCacheKey key, TextOrBytes result)
{
    ...
    public bool IsResultIdenticalTo(RpcCacheEntry other)
        => !Result.IsEmpty && Result.DataEquals(other.Result);
}
